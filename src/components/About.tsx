      ...
      <div className="container">
        <div className="card">
          ...
          <div className="back">
            ...
            <div className="icons">
              <a href="https://instagram.com/astraronix" target="_blank" rel="noopener noreferrer">
              ...
              <a href="https://www.upwork.com/freelancers/~014d831e36d665ff2c?mp_source=share" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" width={32} height={32} fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.561 13.158c-1.102 0-2.135-.467-3.074-1.227l.228-1.076.008-.042c.207-1.143.849-3.06 2.839-3.06 1.492 0 2.703 1.212 2.703 2.703-.001 1.489-1.212 2.702-2.704 2.702zm0-8.14c-2.539 0-4.51 1.649-5.31 4.366-1.22-1.834-2.148-4.036-2.687-5.892H7.828v7.112c-.002 1.406-1.141 2.546-2.547 2.546-1.405 0-2.543-1.14-2.543-2.546V3.492H0v7.112c0 2.917 2.37 5.297 5.281 5.297 2.913 0 5.283-2.38 5.283-5.297V9.06c.54 1.118 1.208 2.235 2.016 3.234l-1.707 8.034h2.89l1.24-5.828c1.08.709 2.316 1.155 3.558 1.155 3.049 0 5.53-2.482 5.53-5.53S21.61 5.024 18.561 5.024z"/>
                </svg>
              </a>
