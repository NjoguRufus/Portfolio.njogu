...
const StyledWrapper = styled.div`
  .Download-button {
    ...
    padding: 12px 20px;
    color: white;
    background: linear-gradient(144deg, rgb(4, 159, 187), rgb(80, 246, 255) 50%, rgb(4, 159, 187));
    border: none;
    box-shadow: 0 0.7em 1.5em -0.5em rgba(4, 159, 187, 0.5);
  ...
  .Download-button:hover {
    box-shadow: 0 0.5em 1.5em -0.5em rgb(80, 246, 255);
    border-top-left-radius: 40px;
    border-bottom-right-radius: 40px;
  }

  .Download-button:active {
    box-shadow: 0 0.3em 1em -0.5em rgb(4, 159, 187);
  }
